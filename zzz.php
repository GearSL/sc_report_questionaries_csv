...
$newstat = pg_query("select dic_questionnaires_status_type.name 
from
questionnaires
...
$countprolong = pg_query("select COUNT(*) as total from questionnaire_extentions where questionnaire_id = $qid") or die('Ошибка запроса: ' . pg_last_error());    
